...
#ggsave(filename = "../lyme_disease/Manuscript/Figures/Figure3/Myeloid_annotated.pdf",p_umap2, width = 5, height = 4, dpi = 300)
...
#ggsave(filename = "./lyme_disease/Manuscript/Figures/Figure3/Myeloid_annotated_bycondition.pdf", p2.5, width = 30, height = 8, dpi = 300)
...
barplot.df$Var1 <- factor(barplot.df$Var1, levels = c("CD16_Mono","S100A9_Mono", "HLA_Mono", "NAMPT_Mono", "cDC","pDC", "X6_Mono", "X5_Mono", "HyperInflam_Mono"))
...
p3
#ggsave("../lyme_disease/Manuscript/Figures/Figure3/barplot_bycluster_removeduplicate_noV7.pdf",p3, width = 10, height = 7, dpi=300)
...
p4 <- ggplot(barplot.df.wide, aes(x=HyperInflam_Mono, y= CD16_Mono, colour = condition)) + 
  geom_point() + geom_smooth(method = "lm") + xlim(0,1) + ylim(0,0.3) 
p4
...
#ggsave(filename = "../lyme_disease/Manuscript/Figures/Figure3/dot_marker_mono.pdf",pdot, width = 9, height = 5, dpi = 300)
...
#ggsave(filename = "../lyme_disease/Manuscript/Figures/Figure3/VlnPlot_Hypoinflam_cluster_Markers.pdf", p1.vln, width = 8, height = 10,dpi = 300)
